...
def predict():
    ...
    query = "INSERT INTO medical_records (percentageofmodel, id, name,Hospital_id, patient_id, created_at, updated_at) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    values = (percentage, results[0][0], results[0][1],results[0][19], results[0][20],  results[0][21], results[0][22]  )
