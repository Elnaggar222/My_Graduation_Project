...
def predict():
    try:
        ...
        patient_id = results[0][19]
        hospital_id = results[0][20]
        ...
        score = clf_loaded.predict_proba([input_vars])[0][1]

        # Insert record into medical_records table
        insert_query = "INSERT INTO medical_records (patient_id, hospital_id, risk_score) VALUES (%s, %s, %s)"
        record_data = (patient_id, hospital_id, score)
